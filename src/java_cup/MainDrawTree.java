...
"    -version       print the version information for CUP and exit\n"
  ...
  protected static void parse_args(String argv[])
      ...
      for (i=0; i<len; i++)
	{
	  ...
	  /* CSA 12/21/97 */
	  else if (argv[i].equals("-interface"))    sym_interface = false;
	  /* CSA 23-Jul-1999 */
  ...
  protected static void emit_parser() throws internal_error
    {
      emit.symbols2(symbol_class_file, include_non_terms, sym_interface);
      emit.parser2(parser_class_file, action_table, reduce_table, 
