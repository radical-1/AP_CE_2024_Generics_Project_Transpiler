 ...
 *    [X ::= * f, {e}]
 *  </pre> 
 *  to indicate that it was currently looking for a Languages.C followed by a d (which
 *  would be reduced into a Languages.C, matching the first symbol in our production
